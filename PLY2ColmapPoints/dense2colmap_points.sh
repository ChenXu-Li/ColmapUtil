...
示例:
  # 单个场景转换 bash dense2colmap_points.sh--dense_ply /root/autodl-tmp/data/MobilePhone/BridgeA/colmap/fused.ply --colmap_sparse_dir /root/autodl-tmp/data/MobilePhone/BridgeA/colmap/sparse/0
